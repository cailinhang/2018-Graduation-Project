...
from neat3.reporting import ReporterSet
from neat3.math_util import mean
from neat3.six_util import iteritems, itervalues
...
class Population(object):
    ...
    def __init__(self, config, initial_state=None):
        ...
        self.checkpointer = Checkpointer(generation_interval=5,
                                         time_interval_seconds=None,
                                         filename_prefix='./checkpoints/parallel-part-neat-checkpoint-')
