...
def eval_genomes(genomes, config):
    ...
    for genome_id, genome in genomes:
        ...
        state_dict = fine_tune.retrain(net.state_dict(), 2*int(state) + 15 + int(cur_generation/5) )
...
if __name__ == '__main__':
    ...
    #config1, init_state = checkpoint.restore_checkpoint('checkpoints/neat-checkpoint-359')
