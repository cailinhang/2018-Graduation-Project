...
from neat1.attributes import FloatAttribute, BoolAttribute, StringAttribute, ListAttribute
    ...
    def crossover(self, gene2):
        ...
        for a in self._gene_attributes:
            if random() < 0.5:
                if (a.name == 'kernal'):
                    pass # TODO: 修改
#                    new_gene.kernal = [self.kernal[0].copy()]
#                    new_gene.kernal = self.kernal.copy()
                else:
                    setattr(new_gene, a.name, getattr(self, a.name))
            else:
                if (a.name == 'kernal'):
                    pass # TODO: 修改
#                    new_gene.kernal = [gene2.kernal[0].copy()]
